<%@ Control Language="VB" CodeBehind="DefaultVerticalTemplateContent1.ascx.vb" ClassName="DefaultVerticalTemplateContent1" Inherits="DefaultVerticalTemplateContent1"%>
                    ...
                    <td style="vertical-align: top; height: 10px;" class="dxsplPane_<%= BaseXafPage.CurrentTheme %>">
                        <div id="VerticalTemplateHeader" class="VerticalTemplateHeader">
                            <table cellpadding="0" cellspacing="0" border="0" class="Top" width="100%">
                                <tr>
                                    <td class="Logo">
                                        <h2>KlemColl Data Manager</h2></td>
                                    <td class="Security">
